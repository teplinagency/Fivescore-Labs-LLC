...
(() => {
    ...
    class t {
        ...
        _init() {
            this._makeLayout(),
                ...
                "true" === this._settings.showFilterAlways.toString() && ((this._settings.enableAutoFilter = !0), this._showHideFilterBox(!0)),
                this.ele.autofocus ? (this._wrapper.holder.focus(), this._wrapper.filterInput.focus()) : this._wrapper.filterInput.blur(),
        ...
        _showHideFilterBox(e = !0) {
            e
                ? (this._show(this._wrapper.filterHolder), this._wrapper.filterInput.focus(), "false" === this._settings.showFilterAlways.toString() && this._hide(this._wrapper.headerA))
                : ((this._wrapper.filterInput.value = ""), this._hide(this._wrapper.filterHolder), this._show(this._wrapper.headerA));
        }
        _applyFilters(e) {
        ...
        _makeChildren(e = null) {
            ...
            this._wrapper.listOfItems ? (t = this._wrapper.listOfItems) : ((t = this._createEle("ul", { className: s.listOfItems, zIndex: this._settings.zIndex })), (this._wrapper.listOfItems = t)), (t.innerHTML = "");
        ...
        _makeLayout() {
            ...
            let t = this._css,
                ...
                i = this.ele.name,
                l = this.ele.required,
                n = this._createEle("input", { tabIndex: -1, name: i, type: "text", className: this._css.valueInput, required: l });
        ...
        _parseOption(e) {
            ...
            return { image: l, title: n, description: r, value: a, text: h, className: d, imageCss: o, index: u, selected: t, disabled: s, internalStyle: i };
        }
        _removeOldSelected() {
        ...
        _updateHeaderUI(e = null, t = null) {
            ...
            if (
                ("true" === this._settings.showPlusItemCounter.toString() && null !== s.ui && s.ui.length > 1 && (l.innerHTML = l.innerHTML + `<span class="${this._css.headerCounter}">&nbsp; (+${s.ui.length - 1})</span>`),
        ...
        _bindDocumentEvents(e, t = !0, s = !0) {
            this._unbindDocumentEvents(),
                ...
                !0 === s && (this._bindEvents(document, "keydown", this._onDocumentKeyDown), this._bindEvents(document, "keyup", this._onDocumentKeyUp));
        }
        ...
        close(e) {
            ...
            this.disabled ||
                ...
                this.ele.length !== this._getAllEle(`li.${this._css.item}`, this._wrapper.listOfItems).length && (this._makeChildren(), this.updateUiAndValue()),
        ...
        set multiple(e) {
            e ? (this.ele.setAttribute("multiple", ""), (this._enableCheckbox = this._settings.enableCheckbox)) : this.ele.removeAttribute("multiple"),
                (this._isMultiple = e),
    ...
    customElements.define("ms-dropdown", i, { extends: "select" }),
        (window.MsDropdown = s),
        navigator.vendor && navigator.vendor.indexOf("Apple") > -1 && navigator.userAgent && -1 == navigator.userAgent.indexOf("CriOS") && -1 == navigator.userAgent.indexOf("FxiOS") && s.make("select[is='ms-dropdown']");
})();
